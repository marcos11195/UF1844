 ...
 * @var string[]|\Cake\Collection\CollectionInterface $tables
 * @var string[]|\Cake\Collection\CollectionInterface $timeSlots
 */
?>
<div class="row">
    <aside class="column">
        ...
        <div class="reservations form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('time_slot_id', ['options' => $timeSlots]);
